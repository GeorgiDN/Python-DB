...
def find_authors_nationalities():
    ...
    result = [f"{a.first_name} {a.last_name} is {a.nationality}" for a in found_authors]
    return "\n".join(result)
...
def filter_authors_by_nationalities(author_nationality: str):
    ...
    result = [
        f'{a.first_name} {a.last_name}' if not a.biography else a.biography for a in authors
    ]
