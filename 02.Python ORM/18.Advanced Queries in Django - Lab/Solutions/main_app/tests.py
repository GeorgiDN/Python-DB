...
# from caller import product_quantity_ordered
# from main_app.models import Category, Product, Customer, Order, OrderProduct
#
# class TotalOrderPriceTestCase(TestCase):
#     def setUp(self):
#         # Categories
...
#         result = product_quantity_ordered()
#         self.assertEqual(result.strip(), """Quantity ordered of Carton of Eggs: 8
# Quantity ordered of Apples: 4
# Quantity ordered of Bottled Water: 4
# Quantity ordered of Tomatoes: 1
# Quantity ordered of  Milk: 1
# Quantity ordered of Orange Soda: 1""")
